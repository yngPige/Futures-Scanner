#!/usr/bin/env python
"""
GUI Launcher script for Blacks Scanner.

This script launches the Blacks Scanner application using the PyBloat directory.
...
def launch_scanner():
    """Launch the Blacks Scanner application."""
...
def main():
    ...
    title_label = tk.Label(root, text="Blacks Scanner", font=("Arial", 24, "bold"), fg="#ffffff", bg="#1e1e1e")
