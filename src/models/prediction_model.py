...
class PredictionModel:
    ...
    def train_model(self, X, y, model_type='random_forest', tune_hyperparams=False):
        ...
        try:
            ...
            # If GridSearchCV was used, print best parameters
            if tune_hyperparams:
            ...
            # If it's a random forest, print feature importances
            if model_type == 'random_forest' or model_type == 'gradient_boosting':
                ...
                for i in range(min(10, len(self.feature_columns))):
                    logger.info(f"{self.feature_columns[indices[i]]}: {importances[indices[i]]:.4f}")
