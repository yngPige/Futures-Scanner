#!/usr/bin/env python
"""
Build a Windows executable launcher for 3lacks Scanner.

This script builds a Windows executable (.exe) file that launches the 3lacks Scanner
...
def build_launcher():
    ...
    print(f"Executable location: {os.path.join(current_dir, 'dist', '3lacks_Scanner.exe')}")
